...
module TheBodyArticle
  class TheBodyProPage < TheBodyPage
    ...
    class Functionality
      ...
      def h1
        h1 = find "div#allcontent h1"
        unless h1
          self.errors.add(:functionality, "div#allcontent h1 missing from page")
        end
        if h1 
          unless h1.text.length > 0
            self.errors.add(:functionality, "div#allcontent h1 was blank")
          end
        end
      end

      def byline
        bylines = @driver.find_elements(:css, "div#allcontent span.byline")
        unless bylines
          self.errors.add(:functionality, "div#allcontent span.byline missing from page")
        end
      ...
      def displaydate
        displaydate = find "div#allcontent p.displaydate"
        unless displaydate
          self.errors.add(:functionality, "div#allcontent p.displaydate missing from page")
        end
        if displaydate 
          unless displaydate.text.length > 0
            self.errors.add(:functionality, "div#allcontent p.displaydate was blank")
          end
        end
      end

      def bodytext
        bodytext = find "div#allcontent div.bodytext"
        unless bodytext
          self.errors.add(:functionality, "div#allcontent div.bodytext missing from page")
        end
        if bodytext 
          unless bodytext.text.length > 0
            self.errors.add(:functionality, "div#allcontent div.bodytext was blank")
          end
        end
      end
