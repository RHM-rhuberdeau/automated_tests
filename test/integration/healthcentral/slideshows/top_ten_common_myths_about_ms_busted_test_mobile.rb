...
class TopTenMobileSlideshowTest < MiniTest::Test
  context "a mobile slideshow, explaining your childs allergies to others" do 
    setup do 
      ...
      @url  = "#{HC_BASE_URL}/multiple-sclerosis/cf/slideshows/top-ten-common-myths-about-ms-busted" + "?foo=#{rand(36**8).to_s(36)}"
      visit @url
    end
