...
class MigrainesMobileSlideshowTest < MiniTest::Test
  context "a mobile sponsored topic slideshow, living well with migraines" do 
    setup do 
      ...
      head_navigation = HealthCentralHeader::SPMobile.new(:logo => "#{ASSET_HOST}com/sites/all/themes/healthcentral/images/logo_lbln.png", 
