...
class SlideshowTest < MiniTest::Test
  context "Adam Other leaf page" do 
    setup do 
      ...
      visit "#{HC_BASE_URL}/encyclopedia/adam/colds-and-the-flu-4021748"
    end
    ...
    context "when functioning properly" do 
      should "have the proper links" do 
        ...
        assert_equal("Colds and the Flu - References", condition)
        assert_equal(false, table_of_contents.nil?)
        assert_equal(9, table_of_contents_a.length)
      end
    end
    ...
    context "ads, analytics, omniture" do
      should "not have any errors" do 
        ...
        ad_categories = ["flu","encyclopedia","alternativemedicine"]
        ads           = HealthCentralAds::AdsTestCases.new(:driver => @driver,
                                                           :proxy => @proxy, 
                                                           :url => "#{HC_BASE_URL}/encyclopedia/adam/colds-and-the-flu-4021748",
                                                           :ad_site => ad_site,
